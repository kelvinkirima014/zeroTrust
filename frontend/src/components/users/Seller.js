    ...
    return (
        <>
            ...
            <div style={{
                ...
                {deedState === "Locked" && <p>"Send the car to the client and wait for confirmation of your client before you receive the money or refund the buyer"</p>}
                ...
                {(deedState === "Closed" || deedState === "Complete") && <Button style={fullWidth} onClick={restart} color="primary" variant="contained">I want to sell a car again</Button>}
